...
void ANPC::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	//PlayerInputComponent->BindTouch(IE_Pressed, this, &ANPC::TouchStarted);
	//PlayerInputComponent->BindTouch(IE_Released, this, &ANPC::TouchStopped);

	// VR headset functionality
	//PlayerInputComponent->BindAction("ResetVR", IE_Pressed, this, &ANPC::OnResetVR);
